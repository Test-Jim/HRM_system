...
function case_ajax(type, editor) {
    ...
    var DubboInterface=$("#DubboInterface").serializeJSON();
    ...
    else if (dataType.DataType === 'params' || dataType.DataType==='data') {
        request_data = $("#form_request_data").serializeJSON();
    }
    else {
        request_data  = editor.session.getValue();
    }
    ...
    const test = {
        "test": {
            ...
            "request": {
                ...
                "headers": headers,
                "DubboInterface":DubboInterface.DubboInterface,
    ...
    if (type === 'edit') {
        ...
        url = '/api/add_case/';
    } else  if(type === 'add_dubbo'){
        url='/api/add_case_dubbo/';
    } else{
        url = '/api/edit_case_dubbo/';
    }
    $.ajax({
        type: 'post',
        url: url,
